...
void ssegInit(void) 
{
  GPIO_Init(SEG1_GPIO_PORT, SEG1_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(SEG2_GPIO_PORT, SEG2_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(SEG3_GPIO_PORT, SEG3_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  
  GPIO_Init(LED_A_GPIO_PORT, LED_A_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_B_GPIO_PORT, LED_B_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_C_GPIO_PORT, LED_C_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_D_GPIO_PORT, LED_D_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_E_GPIO_PORT, LED_E_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_F_GPIO_PORT, LED_F_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_G_GPIO_PORT, LED_G_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
  GPIO_Init(LED_H_GPIO_PORT, LED_H_GPIO_PIN, GPIO_MODE_OUT_PP_HIGH_FAST);
